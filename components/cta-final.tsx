...
// Ícone WhatsApp inline (evita estilos estranhos)
    ...
    <section aria-label="CTA final" className="border-t bg-muted/30 py-16">
      <div className="container mx-auto grid gap-8 px-4 md:grid-cols-[1.2fr_1fr]">
        <div className="flex flex-col justify-center text-center">
          ...
          <div className="mt-8">
            {/* CTA como <a> direto — layout estável */}
            <a
              href={href}
              target="_blank"
              ...
              className="inline-flex items-center justify-center gap-3 leading-none px-12 py-6 text-3xl font-bold rounded-2xl border-2 border-white/70 bg-emerald-500 hover:brightness-95 text-white shadow-md whitespace-nowrap w-full md:w-auto"
            >
              <WhatsIcon size={32} />
              <span className="block leading-none">Chamar no WhatsApp</span>
            </a>
          </div>
        </div>
